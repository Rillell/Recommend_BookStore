...
#EList_box{overflow:auto; width:100%; height:100%;}
#EList_box li { padding: 10px 0; border-bottom: solid 1px #dddddd; }
#EList_box span { display: inline-block; text-align: center;}
#EList_box .col1 { width: 80px; text-align: center; }
#EList_box .col2 { width: 200px; text-align: center; vertical-align:center;}
#EList_box .col3 { width: 200px; text-align: center; vertical-align:center;}
#EList_box .col4 { width: 150px; text-align: center; vertical-align:center;}
#EList_box .col5 { width: 180px; text-align: center; vertical-align:center;}
#EList_box .col6 { width: 100px; text-align: center; vertical-align:center;}
...
$sql = "SELECT num, img, title, author, pag, ranking FROM book_list order by num asc";
...
<span class="col2"><?php echo "<img class='cover' src=" .$img. " alt='표지'>" ?></span>
...
$conn = mysqli_connect("localhost", "cban", "1234", "sample");
$sql = "SELECT num, img, title, author, pag, ranking, PDF FROM book_list order by num asc";
$result = mysqli_query($conn, $sql);
$total_record = mysqli_num_rows($result); //전체글수
...
<span class="col4"><?=$author?></span>
<span class="col5">페이지: <?=$pag?>p<br/><br/>난이도: <?=$ranking?></span>
<!-- <span class="col6"><input type="button" class="now" value="바로읽기"><br/><br/> -->
